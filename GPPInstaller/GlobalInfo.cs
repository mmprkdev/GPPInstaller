...
namespace GPPInstaller
{
    ...
    static class GlobalInfo
    {
        ...
        public static int cloudsLowResIndex = 5;
        public static int cloudsHighResIndex = 6;
        public static int kscSwitcher = 7;
        public static int kerIndex = 8;
        public static int kacIndex = 9;

        // download links GPPInstaller 1.0.0 
        public static string githubJsonDLLink = "https://github.com/mmprkdev/GPPInstallerJson/archive/0.0.0.zip";
        public static string dropboxJsonDLLink = "https://www.dropbox.com/s/xf2iqhjzmzl4215/modList.json?dl=1";

        // TODO: Figure out why Downloader.DownloadAsync() isn't working.
        ...
        // xpath to download
        public static string jsonXpath = "/html/body/div[4]/div/div/div[2]/div[1]/div[2]/div/div[2]/div[2]/ul/li[1]/a";
